...
set DROPME_DEV=0
set DROPME_CHECK_BASKETS=0
cd /d C:\DropMe\gui\dropme-gui-final
C:\DropMe\gui\dropme-gui-final\.venv\Scripts\python.exe -m gui.main > C:\DropMe\run_gui_nobaskets.log 2>&1
type C:\DropMe\run_gui_nobaskets.log
pause
